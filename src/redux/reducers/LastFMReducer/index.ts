import { GetLastFMArtistType, GET_LASTFM_ARTIST_SUCCESS, GET_LASTFM_ARTIST_FAILURE, GET_LASTFM_ARTIST_RESETTER } from "../../Types";
...
export default (state = INITIAL_STATE, action: GetLastFMArtistType) => {
    switch (action.type) {
        case GET_LASTFM_ARTIST_RESETTER:
            return { ...state, noArtistMatches: false }
